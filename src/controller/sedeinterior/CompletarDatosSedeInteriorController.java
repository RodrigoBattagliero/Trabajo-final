 ...
 * @author rodrigo
 */
public class CompletarDatosSedeInteriorController {
    private PanelSolicitudesACompletarSedeInterior view;
    private CompletarDatosSedeInteriorDAO model;
    ...
    public CompletarDatosSedeInteriorController(PanelSolicitudesACompletarSedeInterior view, CompletarDatosSedeInteriorDAO model) {
        this.view = view;
        this.model = model;
