 ...
 * @author rodrigo
 */
public class SolicitudesIniciadasEnSedeInteriorController {
    ...
    public SolicitudesIniciadasEnSedeInteriorController(PanelSolicitudesACompletarOGAGTD view, CompletarDatosOgagtdDAO model) {
        this.view = view;
        this.model = model;
