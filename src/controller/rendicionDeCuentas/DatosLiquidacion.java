...
public class DatosLiquidacion {
    ...
    private CompletarDatosRendicionDeCuentas rendicionDeCuentas;
    ...
    public DatosLiquidacion(PanelRendicionDeCuentas view, LiquidacionDAO model,CompletarDatosRendicionDeCuentas bedel) {
        this.view = view;
        this.model = model;
