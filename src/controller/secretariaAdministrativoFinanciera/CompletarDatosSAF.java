 ...
 * @author rodrigo
 */
public class CompletarDatosSAF {
    private PanelSolicitudesACompletarSedeInterior view;
    private SecretariaAdministrativoFinancieraDAO model;
    ...
    public CompletarDatosSAF(PanelSolicitudesACompletarSedeInterior view, SecretariaAdministrativoFinancieraDAO model) {
        this.view = view;
        this.model = model;
