 ...
 * @author rodrigo
 */
public class VentanaRendicionDeCuentas extends javax.swing.JFrame {

    /**
     * Creates new form VentanaPrincipal
     */
    
    public VentanaRendicionDeCuentas() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaRendicionDeCuentas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaRendicionDeCuentas().setVisible(true);
            }
        });
    }
